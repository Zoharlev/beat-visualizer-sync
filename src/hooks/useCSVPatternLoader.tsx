...
export const useCSVPatternLoader = () => {
  ...
  const loadPatternFromFile = async (): Promise<DrumPattern> => {
    ...
    const filesToTry = [
      'sweet_child_o_mine_drums_16th_beats_1-3.csv',
      ...
      'sweet_child_o_mine_drums_16th_beats-8.csv',
      'sweet_child_o_mine_drums_16th_beats-7.csv',
      'sweet_child_o_mine_drums_16th_beats-6.csv',
      'sweet_child_o_mine_drums_16th_beats-5.csv',
      'sweet_child_o_mine_drums_16th_beats-4.csv',
